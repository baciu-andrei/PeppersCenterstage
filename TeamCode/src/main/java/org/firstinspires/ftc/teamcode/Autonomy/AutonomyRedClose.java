...
import org.firstinspires.ftc.teamcode.Autonomy.utils.RedCloseTrajectory;
...
public class AutonomyRedClose extends LinearOpMode {

    private Controls controls;
    private OutTake outTake;
    public RedCloseTrajectory bt;
    ...
    public void runOpMode() throws InterruptedException{
        ...
        int i = 0;
        bt = new RedCloseTrajectory(mecanumDrive, outTake, controls);
        outTake.update();
