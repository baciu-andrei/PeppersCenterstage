...
import org.firstinspires.ftc.teamcode.Autonomy.utils.BlueFarTrajectory;
...
public class AutonomyBlueFar extends LinearOpMode {

    private Controls controls;
    private OutTake outTake;
    public BlueFarTrajectory bt;
    ...
    public void runOpMode() throws InterruptedException{
        ...
        int i = 0;
        bt = new BlueFarTrajectory(mecanumDrive, outTake, controls);
        outTake.update();
