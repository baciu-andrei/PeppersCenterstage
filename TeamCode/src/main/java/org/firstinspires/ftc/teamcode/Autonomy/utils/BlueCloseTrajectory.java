...
@Config
public class BlueCloseTrajectory {
    ...
    public static double rightX = 6, rightY = 34, rightAngle = 230;
    ...
    public BlueCloseTrajectory(SampleMecanumDrive drive, OutTake outTake, Controls c){
