...
@Config
public class BlueFarTrajectory {
    boolean mirrored, longer;
    public static double offsetX = -10, offsetY = 10;
    public static double backDropOffsetX = 10;
    public static double leftX = 12, leftY = 35.5, leftAngle = 310.73;
    public static double rightX = 6.07, rightY = 34.37, rightAngle = 230;
    public static double middleX = 12, middleY =32, middleAngle = 269.33;
    ...
    public static double mbackdropX = 53, mbackdropY = 30;
    public static double rbackdropX = 53, rbackdropY = 24;
    ...
    public Pose2d initRobotPos = new Pose2d(12.54, 61.90, Math.toRadians(267.43));
    ...
    public BlueFarTrajectory(SampleMecanumDrive drive, OutTake outTake, Controls c){
